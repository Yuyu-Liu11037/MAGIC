...
original_data = ad.read_h5ad("/workspace/MAGIC/data/multiome_preprocessed.h5ad")
...
cell_metadata = pd.read_csv('/workspace/MAGIC/data/multiome_processed_cell_metadata.csv')
gene_metadata = pd.read_csv('/workspace/MAGIC/data/multiome_processed_gene_metadata.csv')
expression_data = pd.read_csv('/workspace/MAGIC/data/multiome_imputed.csv', index_col=0)
...
plt.savefig(f"/workspace/MAGIC/visualization/umap_multiome.png", format="png")
plt.close()
